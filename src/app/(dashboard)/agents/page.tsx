...
const AiCallingPanel = dynamic(
  () => import('@/components/agents/ai-calling-panel').then((mod) => mod.AiCallingPanel),
  { loading: () => <PageSkeleton />, ssr: false },
);
...
function PageSkeleton() {
  return (
    <div
      className="min-h-[420px] animate-pulse rounded-xl border border-border bg-card"
